  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      <div className="w-full max-w-sm glass-card p-8">
        <h1 className="text-2xl font-display font-semibold gold-text text-center mb-6">
        ...
        <form onSubmit={isLogin ? handleLogin : handleSignup} className="space-y-4">
          {!isLogin && (
            <div>
              <Label htmlFor="fullName" className="font-body">Họ tên</Label>
        ...
        <a href="/" className="block text-center text-sm text-muted-foreground mt-3 hover:text-foreground">
          ← Về trang chủ
        </a>
      </div>
    </div>
